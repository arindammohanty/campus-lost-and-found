    ...
    return (
      <div className="p-12 border-2 border-dashed border-black flex flex-col items-center justify-center text-center space-y-6">
        <div className="max-w-md">
          ...
          >
            {!isReady ? (isModelLoading && loadingProgress ? `Downloading AI Model... ${loadingProgress.progress ? Math.round(loadingProgress.progress) : 0}%` : 'Initializing AI Engine...') : 'Start AI Match Scan'}
          </button>
