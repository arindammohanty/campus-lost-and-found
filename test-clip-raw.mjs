import { AutoTokenizer, CLIPTextModelWithProjection, AutoProcessor, CLIPVisionModelWithProjection, env } from '@huggingface/transformers';
...
async function test() {
  ...
  try {
    ...
    const image_inputs = await processor('https://huggingface.co/datasets/Xenova/transformers.js-docs/resolve/main/cat.jpg');
